...
install_requires = ["requests", "jinja2", "bs4", "semver"]
...
setup(
    ...
    url="https://github.com/smetj/bakerman",
    download_url="https://github.com/smetj/bakerman/tarball/master",
    ...
    zip_safe=False,
    entry_points={"console_scripts": ["bakerman = bakerman:main"]},
)
